<!DOCTYPE html><<html lang="en" class="h-full bg-gray-100">
<head>
    <meta charset="UTF-8">
    ...
    <div class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base font-medium leading-none text-white">Haiqal</div>
            <div class="text-sm font-medium leading-none text-gray-400">qal@example.com</div>
          </div>
